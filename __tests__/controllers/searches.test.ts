...
const SearchService = SearchServiceModule as unknown as MockedModule;
...
const { getQueryResults, getQueryStudentsResults, getQueryPublicResults } =
  SearchController as unknown as Record<string, ControllerHandler>;
